...
選んだ瞬間に全ての手の評価が出て、選んだ手の強さが音とエフェクトで返ります。

対局の結果は勝敗ではなく、**最善手にどれだけ近づけたか（0〜100）**で出ます。
...
対局中は右上のつまみから、設定画面からはいつでも変えられます。

- **評価バッジ**: 順位（1位・2位…）／点数（10.0 満点）
- 打てる場所のガイド
- 形勢バー
- 評価を見てから選び直す（既定は切）
- 強さの打感（手の良し悪しで音とエフェクトが変わる）
